...
export default function Download() {
    return(
        <div className="flex justify-evenly p-7 bg-[#F0F0F5] mt-20 items-center flex-col gap-5 lg:flex-row">
            ...
            <div className="flex gap-5"><img src="public/play_store.png" alt=""  className="lg:w-[200px] w-[130px] cursor-pointer" /><img src="public/app_store.png" alt="" className="lg:w-[200px] w-[130px] cursor-pointer" /></div>
        </div>
    )
}